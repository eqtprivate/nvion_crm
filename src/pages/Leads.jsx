...
const STAGE_VISUALS = {
  all: {
    dot: 'bg-slate-500',
    card: 'border-slate-200 dark:border-slate-900/60 bg-slate-50/70 dark:bg-slate-950/30 hover:bg-slate-100/70 dark:hover:bg-slate-900/30',
    active: 'border-slate-700 dark:border-slate-500 bg-slate-100 dark:bg-slate-900/40 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800',
  ...
  novo_contato: {
    dot: 'bg-blue-500',
    card: 'border-blue-200 dark:border-blue-900/60 bg-blue-50/70 dark:bg-blue-950/30 hover:bg-blue-100/70 dark:hover:bg-blue-900/30',
    active: 'border-blue-600 dark:border-blue-500 bg-blue-100 dark:bg-blue-900/40 shadow-sm ring-1 ring-blue-200 dark:ring-blue-800',
  ...
  qualificacao: {
    dot: 'bg-indigo-500',
    card: 'border-indigo-200 dark:border-indigo-900/60 bg-indigo-50/70 dark:bg-indigo-950/30 hover:bg-indigo-100/70 dark:hover:bg-indigo-900/30',
    active: 'border-indigo-600 dark:border-indigo-500 bg-indigo-100 dark:bg-indigo-900/40 shadow-sm ring-1 ring-indigo-200 dark:ring-indigo-800',
  ...
  simulacao: {
    dot: 'bg-violet-500',
    card: 'border-violet-200 dark:border-violet-900/60 bg-violet-50/70 dark:bg-violet-950/30 hover:bg-violet-100/70 dark:hover:bg-violet-900/30',
    active: 'border-violet-600 dark:border-violet-500 bg-violet-100 dark:bg-violet-900/40 shadow-sm ring-1 ring-violet-200 dark:ring-violet-800',
  ...
  proposta_enviada: {
    dot: 'bg-amber-500',
    card: 'border-amber-200 dark:border-amber-900/60 bg-amber-50/70 dark:bg-amber-950/30 hover:bg-amber-100/70 dark:hover:bg-amber-900/30',
    active: 'border-amber-600 dark:border-amber-500 bg-amber-100 dark:bg-amber-900/40 shadow-sm ring-1 ring-amber-200 dark:ring-amber-800',
  ...
  documentacao: {
    dot: 'bg-orange-500',
    card: 'border-orange-200 dark:border-orange-900/60 bg-orange-50/70 dark:bg-orange-950/30 hover:bg-orange-100/70 dark:hover:bg-orange-900/30',
    active: 'border-orange-600 dark:border-orange-500 bg-orange-100 dark:bg-orange-900/40 shadow-sm ring-1 ring-orange-200 dark:ring-orange-800',
  ...
  em_aprovacao: {
    dot: 'bg-cyan-500',
    card: 'border-cyan-200 dark:border-cyan-900/60 bg-cyan-50/70 dark:bg-cyan-950/30 hover:bg-cyan-100/70 dark:hover:bg-cyan-900/30',
    active: 'border-cyan-600 dark:border-cyan-500 bg-cyan-100 dark:bg-cyan-900/40 shadow-sm ring-1 ring-cyan-200 dark:ring-cyan-800',
  ...
  venda_concluida: {
    dot: 'bg-emerald-500',
    card: 'border-emerald-200 dark:border-emerald-900/60 bg-emerald-50/70 dark:bg-emerald-950/30 hover:bg-emerald-100/70 dark:hover:bg-emerald-900/30',
    active: 'border-emerald-600 dark:border-emerald-500 bg-emerald-100 dark:bg-emerald-900/40 shadow-sm ring-1 ring-emerald-200 dark:ring-emerald-800',
  ...
  perdida: {
    dot: 'bg-rose-500',
    card: 'border-rose-200 dark:border-rose-900/60 bg-rose-50/70 dark:bg-rose-950/30 hover:bg-rose-100/70 dark:hover:bg-rose-900/30',
    active: 'border-rose-600 dark:border-rose-500 bg-rose-100 dark:bg-rose-900/40 shadow-sm ring-1 ring-rose-200 dark:ring-rose-800',
...
export default function Leads() {
  ...
  return (
    <div className="p-4 sm:p-8 bg-gray-50 dark:bg-background min-h-screen">
      ...
      <LeadDialog open={dialogOpen} onOpenChange={setDialogOpen} onSubmit={data => createMutation.mutate(data)} isLoading={createMutation.isPending} currentUser={user} produtos={produtos} administradoras={administradoras} vendedores={vendedores} equipes={equipes} campanhas={campanhas} />
      <EditLeadDialog open={editDialogOpen} onOpenChange={setEditDialogOpen} lead={selectedLead} onSubmit={data => updateMutation.mutate({ id: selectedLead.id, data })} isLoading={updateMutation.isPending} produtos={produtos} administradoras={administradoras} vendedores={vendedores} equipes={equipes} campanhas={campanhas} />
