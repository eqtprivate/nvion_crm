    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant="outline" size="sm">
          ...
          Filtros {hasActive && <span className="ml-1 w-2 h-2 rounded-full bg-primary inline-block" />}
        </Button>
      </PopoverTrigger>
      <PopoverContent className="w-72" align="start">
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select value={filters.origem} onValueChange={v => onFilterChange('origem', v)}>
          ...
          <div>
            ...
            <Select value={filters.temperatura} onValueChange={v => onFilterChange('temperatura', v)}>
              <SelectTrigger><SelectValue placeholder="Todas" /></SelectTrigger>
              <SelectContent>
                <SelectItem value="all">Todas</SelectItem>
          ...
          <Button variant="outline" className="w-full" onClick={() => { onClearFilters(); setOpen(false); }}>
